...
export const importedReviews = {
  reviews: [
    {
      id: 1,
      name: 'Arun',
      stars: 5,
      writtenReview: `This property is one of the best Airbnb’s I have stayed in.
    ...
    },
    {
      ...
      name: 'Jay',
      stars: 5,
      writtenReview: `The bird house was a really great place for us to vacation! We
